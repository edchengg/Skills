...
generate(
    ...
    output_dir=output_dir + model_name + "/curriculum_v7_acrid-teal_main_rename.filtered",
    # can customize the number of GPUs used
    server_gpus=8,
    input_file="/lustre/fsw/portfolios/llmservice/projects/llmservice_fm_text/users/yachen/AceMath/AceProof/data_processing_rl/curriculum_v7_acrid-teal_main_rename.filtered.jsonl",
    dependent_jobs=4,
    starting_seed=0,
    num_random_seeds=16,
)
