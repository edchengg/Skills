...
generate(
    ...
    starting_seed=0,
    num_random_seeds=3,
    input_file="/scratch/fsw/portfolios/llmservice/users/yachen/AceMath/AceProof/nemotron_math_proofs_v1_aops_les10k.jsonl",
    output_dir=f"{output_dir}/nemotron_math_proofs_v1_aops_les10k/",
